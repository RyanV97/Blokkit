...
public class EntityBigWoodBlokkit extends EntityWoodBlokkit
{
    public EntityBigWoodBlokkit(World world)
    {
        super(world);
        setSize(1.2F, 1.6F);
    }
    ...
    public void evolve(EntityPlayer player)
    {
        ...
        {
            EntityGiantWoodBlokkit newBlokkit = new EntityGiantWoodBlokkit(this.worldObj);
