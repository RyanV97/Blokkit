...
public class ItemIronBlokkit extends ItemBlokkit
{
    public ItemIronBlokkit()
    {
        super();
        this.setUnlocalizedName("ironBlokkit");
        this.setMaxStackSize(1);
    }

    public static Entity spawnCreature(World par0World, double x, double y, double z)
    {
        EntityIronBlokkit blokkit = new EntityIronBlokkit(par0World);
