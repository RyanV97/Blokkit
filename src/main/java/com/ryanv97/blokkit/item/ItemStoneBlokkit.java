...
public class ItemStoneBlokkit extends ItemBlokkit
{
    public ItemStoneBlokkit()
    {
        super();
        this.setUnlocalizedName("stoneBlokkit");
        this.setMaxStackSize(1);
    }

    public static Entity spawnCreature(World par0World, double x, double y, double z)
    {
        EntityStoneBlokkit blokkit = new EntityStoneBlokkit(par0World);
