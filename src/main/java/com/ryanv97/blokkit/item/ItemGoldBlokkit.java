...
public class ItemGoldBlokkit extends ItemBlokkit
{
    public ItemGoldBlokkit()
    {
        super();
        this.setUnlocalizedName("goldBlokkit");
        this.setMaxStackSize(1);
    }

    public static Entity spawnCreature(World par0World, double x, double y, double z)
    {
        EntityGoldBlokkit blokkit = new EntityGoldBlokkit(par0World);
